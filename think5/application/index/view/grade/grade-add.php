...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" placeholder="班级名称" id="name" name="name" style="width: 500px">
		</div>
	</div>
    ...
    <div class="row cl">
            ...
            <div class="formControls col-xs-8 col-sm-9">
                <input type="text" class="input-text" autocomplete="off" placeholder="学制" id="length" name="length" style="width: 500px">
            </div>
    </div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" autocomplete="off" placeholder="学费" id="price" name="price" style="width: 500px">
		</div>
	</div>
        <div class="row cl">
            <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>开班时间:</label>
            <div class="formControls col-xs-8 col-sm-9">
                <input id="hiredate" name="hiredate" placeholder="开班时间" type="date" value="">
            </div>
        </div>
	<div class="row cl">
