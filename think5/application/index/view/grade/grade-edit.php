    ...
    <form action="" method="post" class="form form-horizontal" id="form-grade-edit">
      ...
      <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>班级名称:</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" class="input-text disable" value="{$grade_info.name}" placeholder="班级名称" id="name" name="name" style="width: 200px">
            </div>
      </div>
      ...
      <div class="row cl">
        ...
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="text" id="length" name="length" class="input-text" autocomplete="off" placeholder="学制" value="{$grade_info.length}" style="width: 200px">
        </div>
      </div>
      ...
      <div class="row cl">
        ...
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="text" class="input-text" id="price" name="price" placeholder="学费" value="{$grade_info.price}" style="width: 200px">
        </div>
      </div>
	  ...
	  <div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
             <input id="hiredate" name="hiredate" placeholder="开班时间" type="date" value="{$grade_info.hiredate}">
        </div>
	  </div>
        ...
        <div class="row cl">
            ...
            <div class="form-Controls col-xs-8 col-sm-9">
               <input type="text" class="input-text disabled readonly" readonly id="teacher" name="teacher" value="{$grade_info.teacher}" style="width: 200px"/>
            </div>
        </div>
