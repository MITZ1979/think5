      ...
      <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>班级:</label>
            <div class="formControls col-xs-8 col-sm-9">
              <input type="text" class="input-text disable" value="{$grade_info.name}" placeholder="班级" id="name" name="name" style="width: 500px">
            </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学制:</label>
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="text" id="length" name="length" class="input-text" autocomplete="off" placeholder="学制" value="{$grade_info.length}" style="width: 500px">
        </div>
      </div>
      <div class="row cl">
        <label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>学费:</label>
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="text" class="input-text" id="price" name="price" placeholder="学费" value="{$grade_info.price}" style="width: 500px">
        </div>
      </div>
