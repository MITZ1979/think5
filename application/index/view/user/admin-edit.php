...
<body>
  <article class="cl pd-20">
    <form action="{:url('user/editUser')}" method="post" class="form form-horizontal" id="form-admin-edit">
      <div class="row cl">
          <label class="form-label col-xs-4 col-sm-3"><span class="c-red">管理员:</span></label>
            <div class="formControls col-xs-8 col-sm-9">
              {eq name="$user_info.name" value="admin"}
              <input type="text" class="input-text disable" value="{$user_info.name}" placeholder="" id="name" name="name" style="width: 500px">
              {else /}
      ...
      <div class="row cl">
        ...
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="password" class="input-text" autocomplete="off" value="{$user_info.password}" placeholder="密码6位数" id="password" name="password" style="width: 500px">
        </div>
      </div>
      ...
      <div class="row cl">
        ...
        <div class="form-Controls col-xs-8 col-sm-9">
          <input type="email" class="input-text" id="email" name="email" placeholder="@" value="{$user_info.email}" style="width: 500px">
        </div>
      </div>
      {eq name="$Think.session.user_info.name" value="admin"}
      <div class="row cl">
