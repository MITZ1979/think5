...
<article class="page-container">
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
			<input type="text" class="input-text" id="name" name="name" placeholder="姓名" style="width: 500px">
		</div>
	</div>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9"><span class="select-box" style="width: 150px;">
                <select class="select" name="degree" size="1">
                    <option selected value="专科生">专科生</option>
	...
	<div class="row cl">
		...
		<div class="formControls col-xs-8 col-sm-9">
            <input type="text" id="school" name="school" class="input-text" placeholder="毕业学校" style="width: 500px">
		</div>
	</div>
    ...
    <div class="row cl">
        ...
        <div class="formControls col-xs-8 col-sm-9">
            <input type="text" class="input-text" maxlength="11" placeholder="phoneNumber" name="mobile" id="mobile" style="width: 500px">
        </div>
    </div>
...
$(function(){
    ...
    $("#submit").on("click",function (event) {
        $.ajax({
            ...
            data:$("#form-teacher-add").serialize(),
            dataType:"json",
